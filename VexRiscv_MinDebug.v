...
module VexRiscv (
  ...
  assign _zz_193_ = debug_bus_cmd_payload_address[7 : 2];
  assign _zz_194_ = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < (2'b11)));
  assign _zz_195_ = ((_zz_153_ && 1'b1) && (! 1'b0));
  assign _zz_196_ = ((_zz_154_ && 1'b1) && (! 1'b0));
  assign _zz_197_ = ((_zz_155_ && 1'b1) && (! 1'b0));
