...
module VexRiscv (
  ...
  reg [23:0] _zz_126__string;
  reg [31:0] _zz_127__string;
  reg [31:0] _zz_128__string;
  ...
  assign _zz_171_ = ((execute_arbitration_isValid && execute_LightShifterPlugin_isShift) && (execute_SRC2[4 : 0] != (5'b00000)));
  assign _zz_172_ = (execute_arbitration_isValid && execute_IS_CSR);
  assign _zz_173_ = ({decodeExceptionPort_valid,IBusSimplePlugin_decodeExceptionPort_valid} != (2'b00));
  assign _zz_174_ = (! execute_arbitration_isStuckByOthers);
  assign _zz_175_ = (execute_arbitration_isValid && execute_DO_EBREAK);
  assign _zz_176_ = ({BranchPlugin_branchExceptionPort_valid,DBusSimplePlugin_memoryExceptionPort_valid} != (2'b00));
  assign _zz_177_ = (({writeBack_arbitration_isValid,memory_arbitration_isValid} != (2'b00)) == 1'b0);
  assign _zz_178_ = (CsrPlugin_hadException || CsrPlugin_interruptJump);
  assign _zz_179_ = (writeBack_arbitration_isValid && (writeBack_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_XRET));
  assign _zz_180_ = (DebugPlugin_stepIt && IBusSimplePlugin_incomingInstruction);
  assign _zz_181_ = writeBack_INSTRUCTION[29 : 28];
  assign _zz_182_ = (IBusSimplePlugin_fetchPc_preOutput_valid && IBusSimplePlugin_fetchPc_preOutput_ready);
  assign _zz_183_ = (IBusSimplePlugin_mmuBus_rsp_exception || IBusSimplePlugin_mmuBus_rsp_refilling);
  assign _zz_184_ = ((IBusSimplePlugin_iBusRsp_stages_1_input_valid && (! IBusSimplePlugin_mmu_joinCtx_refilling)) && (IBusSimplePlugin_mmu_joinCtx_exception || (! IBusSimplePlugin_mmu_joinCtx_allowExecute)));
  assign _zz_185_ = ((dBus_rsp_ready && dBus_rsp_error) && (! memory_MEMORY_STORE));
  assign _zz_186_ = (! ((memory_arbitration_isValid && memory_MEMORY_ENABLE) && (1'b1 || (! memory_arbitration_isStuckByOthers))));
  assign _zz_187_ = (writeBack_arbitration_isValid && writeBack_REGFILE_WRITE_VALID);
  assign _zz_188_ = (1'b1 || (! 1'b1));
  assign _zz_189_ = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_190_ = (1'b1 || (! memory_BYPASSABLE_MEMORY_STAGE));
  assign _zz_191_ = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_192_ = (1'b1 || (! execute_BYPASSABLE_EXECUTE_STAGE));
  assign _zz_193_ = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < (2'b11)));
  assign _zz_194_ = ((_zz_153_ && 1'b1) && (! 1'b0));
  assign _zz_195_ = ((_zz_154_ && 1'b1) && (! 1'b0));
  assign _zz_196_ = ((_zz_155_ && 1'b1) && (! 1'b0));
  assign _zz_197_ = debug_bus_cmd_payload_address[7 : 2];
  assign _zz_198_ = (! dBus_cmd_halfPipe_regs_valid);
  assign _zz_199_ = writeBack_INSTRUCTION[13 : 12];
  assign _zz_200_ = execute_INSTRUCTION[13];
  assign _zz_201_ = (_zz_92_ - (4'b0001));
  assign _zz_202_ = {IBusSimplePlugin_fetchPc_inc,(2'b00)};
  assign _zz_203_ = {29'd0, _zz_202_};
  assign _zz_204_ = (IBusSimplePlugin_pendingCmd + _zz_206_);
  assign _zz_205_ = (IBusSimplePlugin_cmd_valid && IBusSimplePlugin_cmd_ready);
  assign _zz_206_ = {2'd0, _zz_205_};
  assign _zz_207_ = iBus_rsp_valid;
  assign _zz_208_ = {2'd0, _zz_207_};
  assign _zz_209_ = (iBus_rsp_valid && (IBusSimplePlugin_rspJoin_discardCounter != (3'b000)));
  assign _zz_210_ = {2'd0, _zz_209_};
  assign _zz_211_ = iBus_rsp_valid;
  assign _zz_212_ = {2'd0, _zz_211_};
  assign _zz_213_ = (memory_MEMORY_STORE ? (3'b110) : (3'b100));
  assign _zz_214_ = _zz_117_[4 : 4];
  assign _zz_215_ = _zz_117_[7 : 7];
  assign _zz_216_ = _zz_117_[9 : 9];
  assign _zz_217_ = _zz_117_[10 : 10];
  assign _zz_218_ = _zz_117_[11 : 11];
  assign _zz_219_ = _zz_117_[14 : 14];
  assign _zz_220_ = _zz_117_[17 : 17];
  assign _zz_221_ = _zz_117_[18 : 18];
  assign _zz_222_ = _zz_117_[19 : 19];
  assign _zz_223_ = _zz_117_[22 : 22];
  assign _zz_224_ = _zz_117_[23 : 23];
  assign _zz_225_ = _zz_117_[24 : 24];
  assign _zz_226_ = execute_SRC_LESS;
  assign _zz_227_ = (3'b100);
  assign _zz_228_ = execute_INSTRUCTION[19 : 15];
  assign _zz_229_ = execute_INSTRUCTION[31 : 20];
  assign _zz_230_ = {execute_INSTRUCTION[31 : 25],execute_INSTRUCTION[11 : 7]};
  assign _zz_231_ = ($signed(_zz_232_) + $signed(_zz_235_));
  assign _zz_232_ = ($signed(_zz_233_) + $signed(_zz_234_));
  assign _zz_233_ = execute_SRC1;
  assign _zz_234_ = (execute_SRC_USE_SUB_LESS ? (~ execute_SRC2) : execute_SRC2);
  assign _zz_235_ = (execute_SRC_USE_SUB_LESS ? _zz_236_ : _zz_237_);
  assign _zz_236_ = (32'b00000000000000000000000000000001);
  assign _zz_237_ = (32'b00000000000000000000000000000000);
  assign _zz_238_ = (_zz_239_ >>> 1);
  assign _zz_239_ = {((execute_SHIFT_CTRL == `ShiftCtrlEnum_defaultEncoding_SRA_1) && execute_LightShifterPlugin_shiftInput[31]),execute_LightShifterPlugin_shiftInput};
  ...
  assign _zz_242_ = {{{execute_INSTRUCTION[31],execute_INSTRUCTION[7]},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]};
  assign _zz_243_ = (_zz_156_ & (~ _zz_244_));
  assign _zz_244_ = (_zz_156_ - (2'b01));
  assign _zz_245_ = (_zz_158_ & (~ _zz_246_));
  assign _zz_246_ = (_zz_158_ - (2'b01));
  assign _zz_247_ = execute_CsrPlugin_writeData[7 : 7];
  assign _zz_248_ = execute_CsrPlugin_writeData[3 : 3];
  assign _zz_249_ = execute_CsrPlugin_writeData[3 : 3];
  assign _zz_250_ = execute_CsrPlugin_writeData[11 : 11];
  assign _zz_251_ = execute_CsrPlugin_writeData[7 : 7];
  assign _zz_252_ = execute_CsrPlugin_writeData[3 : 3];
  assign _zz_253_ = ({3'd0,_zz_166_} <<< dBus_cmd_halfPipe_payload_address[1 : 0]);
  assign _zz_254_ = 1'b1;
  assign _zz_255_ = 1'b1;
  assign _zz_256_ = {_zz_96_,_zz_95_};
  assign _zz_257_ = (32'b00000000000100000011000001010000);
  assign _zz_258_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000000000));
  assign _zz_259_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_260_ = ((decode_INSTRUCTION & _zz_267_) == (32'b00000000000000000000000000100100));
  assign _zz_261_ = ((decode_INSTRUCTION & _zz_268_) == (32'b00000000000000000001000000010000));
  assign _zz_262_ = ((decode_INSTRUCTION & _zz_269_) == (32'b00000000000000000000000000010000));
  assign _zz_263_ = (1'b0);
  assign _zz_264_ = ({_zz_120_,_zz_270_} != (2'b00));
  assign _zz_265_ = (_zz_271_ != (1'b0));
  assign _zz_266_ = {(_zz_272_ != _zz_273_),{_zz_274_,{_zz_275_,_zz_276_}}};
  assign _zz_267_ = (32'b00000000000000000000000001100100);
  assign _zz_268_ = (32'b00000000000000000011000001010100);
  assign _zz_269_ = (32'b00000000000000000000000000010000);
  assign _zz_270_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011100)) == (32'b00000000000000000000000000000100));
  assign _zz_271_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_272_ = {(_zz_277_ == _zz_278_),{_zz_279_,{_zz_280_,_zz_281_}}};
  assign _zz_273_ = (4'b0000);
  assign _zz_274_ = (_zz_119_ != (1'b0));
  assign _zz_275_ = (_zz_282_ != (1'b0));
  assign _zz_276_ = {(_zz_283_ != _zz_284_),{_zz_285_,{_zz_286_,_zz_287_}}};
  ...
  assign _zz_279_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_280_ = ((decode_INSTRUCTION & _zz_288_) == (32'b00000000000000000010000000000000));
  assign _zz_281_ = ((decode_INSTRUCTION & _zz_289_) == (32'b00000000000000000001000000000000));
  assign _zz_282_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000100000));
  assign _zz_283_ = {_zz_121_,(_zz_290_ == _zz_291_)};
  assign _zz_284_ = (2'b00);
  assign _zz_285_ = ({_zz_121_,_zz_292_} != (2'b00));
  assign _zz_286_ = ({_zz_293_,_zz_294_} != (2'b00));
  assign _zz_287_ = {(_zz_295_ != _zz_296_),{_zz_297_,{_zz_298_,_zz_299_}}};
  assign _zz_288_ = (32'b00000000000000000110000000000100);
  assign _zz_289_ = (32'b00000000000000000101000000000100);
  assign _zz_290_ = (decode_INSTRUCTION & (32'b00000000000000000000000001110000));
  assign _zz_291_ = (32'b00000000000000000000000000100000);
  assign _zz_292_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000100000)) == (32'b00000000000000000000000000000000));
  assign _zz_293_ = ((decode_INSTRUCTION & _zz_300_) == (32'b00000000000000000001000001010000));
  assign _zz_294_ = ((decode_INSTRUCTION & _zz_301_) == (32'b00000000000000000010000001010000));
  assign _zz_295_ = ((decode_INSTRUCTION & _zz_302_) == (32'b00000000000000000001000000000000));
  assign _zz_296_ = (1'b0);
  assign _zz_297_ = ((_zz_303_ == _zz_304_) != (1'b0));
  assign _zz_298_ = (_zz_305_ != (1'b0));
  assign _zz_299_ = {(_zz_306_ != _zz_307_),{_zz_308_,{_zz_309_,_zz_310_}}};
  assign _zz_300_ = (32'b00000000000000000001000001010000);
  assign _zz_301_ = (32'b00000000000000000010000001010000);
  assign _zz_302_ = (32'b00000000000000000001000000000000);
  assign _zz_303_ = (decode_INSTRUCTION & (32'b00000000000000000011000000000000));
  assign _zz_304_ = (32'b00000000000000000010000000000000);
  assign _zz_305_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000000000000));
  assign _zz_306_ = {(_zz_311_ == _zz_312_),(_zz_313_ == _zz_314_)};
  assign _zz_307_ = (2'b00);
  assign _zz_308_ = ((_zz_315_ == _zz_316_) != (1'b0));
  assign _zz_309_ = ({_zz_317_,_zz_318_} != (3'b000));
  assign _zz_310_ = {(_zz_319_ != _zz_320_),{_zz_321_,{_zz_322_,_zz_323_}}};
  assign _zz_311_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_312_ = (32'b00000000000000000000000000100000);
  assign _zz_313_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_314_ = (32'b00000000000000000000000000100000);
  assign _zz_315_ = (decode_INSTRUCTION & (32'b00010000000000000011000001010000));
  assign _zz_316_ = (32'b00000000000000000000000001010000);
  assign _zz_317_ = ((decode_INSTRUCTION & _zz_324_) == (32'b00000000000000000000000001000000));
  assign _zz_318_ = {(_zz_325_ == _zz_326_),(_zz_327_ == _zz_328_)};
  assign _zz_319_ = {(_zz_329_ == _zz_330_),{_zz_331_,_zz_332_}};
  assign _zz_320_ = (3'b000);
  assign _zz_321_ = ({_zz_333_,_zz_334_} != (2'b00));
  assign _zz_322_ = (_zz_335_ != (1'b0));
  assign _zz_323_ = {(_zz_336_ != _zz_337_),{_zz_338_,{_zz_339_,_zz_340_}}};
  assign _zz_324_ = (32'b00000000000000000000000001010000);
  assign _zz_325_ = (decode_INSTRUCTION & (32'b00000000000000000000000000111000));
  assign _zz_326_ = (32'b00000000000000000000000000000000);
  assign _zz_327_ = (decode_INSTRUCTION & (32'b00000000000100000011000001000000));
  ...
  assign _zz_331_ = ((decode_INSTRUCTION & _zz_341_) == (32'b00000000000000000010000000010000));
  assign _zz_332_ = ((decode_INSTRUCTION & _zz_342_) == (32'b01000000000000000000000000110000));
  assign _zz_333_ = ((decode_INSTRUCTION & _zz_343_) == (32'b00000000000000000110000000010000));
  assign _zz_334_ = ((decode_INSTRUCTION & _zz_344_) == (32'b00000000000000000100000000010000));
  assign _zz_335_ = ((decode_INSTRUCTION & _zz_345_) == (32'b00000000000000000010000000010000));
  assign _zz_336_ = {_zz_120_,{_zz_346_,_zz_347_}};
  assign _zz_337_ = (6'b000000);
  assign _zz_338_ = ({_zz_348_,_zz_349_} != (2'b00));
  assign _zz_339_ = (_zz_350_ != _zz_351_);
  assign _zz_340_ = {_zz_352_,_zz_353_};
  assign _zz_341_ = (32'b00000000000000000010000000010100);
  assign _zz_342_ = (32'b01000000000000000100000000110100);
  assign _zz_343_ = (32'b00000000000000000110000000010100);
  assign _zz_344_ = (32'b00000000000000000101000000010100);
  assign _zz_345_ = (32'b00000000000000000110000000010100);
  assign _zz_346_ = ((decode_INSTRUCTION & _zz_354_) == (32'b00000000000000000001000000010000));
  assign _zz_347_ = {(_zz_355_ == _zz_356_),{_zz_119_,{_zz_357_,_zz_358_}}};
  assign _zz_348_ = ((decode_INSTRUCTION & _zz_359_) == (32'b00000000000000000000000000000100));
  assign _zz_349_ = _zz_118_;
  assign _zz_350_ = {(_zz_360_ == _zz_361_),_zz_118_};
  assign _zz_351_ = (2'b00);
  assign _zz_352_ = ((_zz_362_ == _zz_363_) != (1'b0));
  assign _zz_353_ = ({_zz_364_,_zz_365_} != (2'b00));
  assign _zz_354_ = (32'b00000000000000000001000000010000);
  assign _zz_355_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_356_ = (32'b00000000000000000010000000010000);
  assign _zz_357_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000001100)) == (32'b00000000000000000000000000000100));
  assign _zz_358_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000000000));
  assign _zz_359_ = (32'b00000000000000000000000000010100);
  assign _zz_360_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_361_ = (32'b00000000000000000000000000000100);
  assign _zz_362_ = (decode_INSTRUCTION & (32'b00000000000000000111000001010100));
  assign _zz_363_ = (32'b00000000000000000101000000010000);
  assign _zz_364_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_365_ = ((decode_INSTRUCTION & (32'b00000000000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_366_ = (32'b00000000000000000001000001111111);
  assign _zz_367_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_368_ = (32'b00000000000000000010000001110011);
  assign _zz_369_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_370_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_371_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_372_) == (32'b00000000000000000000000000000011)),{(_zz_373_ == _zz_374_),{_zz_375_,{_zz_376_,_zz_377_}}}}}};
  assign _zz_372_ = (32'b00000000000000000101000001011111);
  assign _zz_373_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_374_ = (32'b00000000000000000000000001100011);
  assign _zz_375_ = ((decode_INSTRUCTION & (32'b00000000000000000110000001111111)) == (32'b00000000000000000000000000001111));
  assign _zz_376_ = ((decode_INSTRUCTION & (32'b11111110000000000000000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_377_ = {((decode_INSTRUCTION & (32'b10111100000000000111000001111111)) == (32'b00000000000000000101000000010011)),{((decode_INSTRUCTION & (32'b11111100000000000011000001111111)) == (32'b00000000000000000001000000010011)),{((decode_INSTRUCTION & _zz_378_) == (32'b00000000000000000101000000110011)),{(_zz_379_ == _zz_380_),{_zz_381_,_zz_382_}}}}};
  assign _zz_378_ = (32'b10111110000000000111000001111111);
  assign _zz_379_ = (decode_INSTRUCTION & (32'b10111110000000000111000001111111));
  assign _zz_380_ = (32'b00000000000000000000000000110011);
  assign _zz_381_ = ((decode_INSTRUCTION & (32'b11011111111111111111111111111111)) == (32'b00010000001000000000000001110011));
  assign _zz_382_ = ((decode_INSTRUCTION & (32'b11111111111111111111111111111111)) == (32'b00000000000100000000000001110011));
  always @ (posedge clk) begin
    if(_zz_51_) begin
  ...
  always @(*) begin
    case(_zz_256_)
      ...
      default : begin
        _zz_170_ = IBusSimplePlugin_redoBranch_payload;
      end
    endcase
  end
  ...
  always @(*) begin
    case(_zz_126_)
      `Src2CtrlEnum_defaultEncoding_RS : _zz_126__string = "RS ";
      `Src2CtrlEnum_defaultEncoding_IMI : _zz_126__string = "IMI";
      `Src2CtrlEnum_defaultEncoding_IMS : _zz_126__string = "IMS";
      `Src2CtrlEnum_defaultEncoding_PC : _zz_126__string = "PC ";
  ...
  always @(*) begin
    case(_zz_128_)
      `EnvCtrlEnum_defaultEncoding_NONE : _zz_128__string = "NONE";
      `EnvCtrlEnum_defaultEncoding_XRET : _zz_128__string = "XRET";
  ...
  assign decode_BYPASSABLE_MEMORY_STAGE = _zz_57_;
  ...
  always @ (*) begin
    decode_REGFILE_WRITE_VALID = _zz_70_;
  ...
  always @ (*) begin
    ...
    if((decode_arbitration_isValid && (_zz_138_ || _zz_139_)))begin
  ...
  always @ (*) begin
    ...
    if(((((execute_arbitration_isValid && execute_MEMORY_ENABLE) && (! dBus_cmd_ready)) && (! execute_DBusSimplePlugin_skipCmd)) && (! _zz_110_)))begin
  ...
  assign _zz_93_ = (_zz_92_ & (~ _zz_201_));
  assign _zz_94_ = _zz_93_[3];
  assign _zz_95_ = (_zz_93_[1] || _zz_94_);
  assign _zz_96_ = (_zz_93_[2] || _zz_94_);
  assign IBusSimplePlugin_jump_pcLoad_payload = _zz_170_;
  assign _zz_97_ = (! IBusSimplePlugin_fetcherHalt);
  assign IBusSimplePlugin_fetchPc_output_valid = (IBusSimplePlugin_fetchPc_preOutput_valid && _zz_97_);
  assign IBusSimplePlugin_fetchPc_preOutput_ready = (IBusSimplePlugin_fetchPc_output_ready && _zz_97_);
  ...
  always @ (*) begin
    IBusSimplePlugin_fetchPc_pc = (IBusSimplePlugin_fetchPc_pcReg + _zz_203_);
  ...
  assign IBusSimplePlugin_fetchPc_preOutput_valid = _zz_98_;
  ...
  assign _zz_99_ = (! IBusSimplePlugin_iBusRsp_stages_0_halt);
  always @ (*) begin
    IBusSimplePlugin_iBusRsp_stages_0_input_ready = (IBusSimplePlugin_iBusRsp_stages_0_output_ready && _zz_99_);
    if(IBusSimplePlugin_mmuBus_busy)begin
      IBusSimplePlugin_iBusRsp_stages_0_input_ready = 1'b0;
    end
  end

  assign IBusSimplePlugin_iBusRsp_stages_0_output_valid = (IBusSimplePlugin_iBusRsp_stages_0_input_valid && _zz_99_);
  assign IBusSimplePlugin_iBusRsp_stages_0_output_payload = IBusSimplePlugin_iBusRsp_stages_0_input_payload;
  assign IBusSimplePlugin_iBusRsp_stages_1_halt = 1'b0;
  assign _zz_100_ = (! IBusSimplePlugin_iBusRsp_stages_1_halt);
  assign IBusSimplePlugin_iBusRsp_stages_1_input_ready = (IBusSimplePlugin_iBusRsp_stages_1_output_ready && _zz_100_);
  assign IBusSimplePlugin_iBusRsp_stages_1_output_valid = (IBusSimplePlugin_iBusRsp_stages_1_input_valid && _zz_100_);
  assign IBusSimplePlugin_iBusRsp_stages_1_output_payload = IBusSimplePlugin_iBusRsp_stages_1_input_payload;
  assign IBusSimplePlugin_iBusRsp_stages_0_output_ready = _zz_101_;
  assign _zz_101_ = ((1'b0 && (! _zz_102_)) || IBusSimplePlugin_iBusRsp_stages_1_input_ready);
  assign _zz_102_ = _zz_103_;
  assign IBusSimplePlugin_iBusRsp_stages_1_input_valid = _zz_102_;
  ...
  assign IBusSimplePlugin_injector_decodeInput_valid = _zz_104_;
  assign IBusSimplePlugin_injector_decodeInput_payload_pc = _zz_105_;
  assign IBusSimplePlugin_injector_decodeInput_payload_rsp_error = _zz_106_;
  assign IBusSimplePlugin_injector_decodeInput_payload_rsp_inst = _zz_107_;
  assign IBusSimplePlugin_injector_decodeInput_payload_isRvc = _zz_108_;
  ...
  assign IBusSimplePlugin_pendingCmdNext = (_zz_204_ - _zz_208_);
  always @ (*) begin
  ...
  assign _zz_167_ = (IBusSimplePlugin_jump_pcLoad_valid || IBusSimplePlugin_fetcherflushIt);
  ...
  assign _zz_109_ = (! (IBusSimplePlugin_rspJoin_exceptionDetected || IBusSimplePlugin_rspJoin_redoRequired));
  assign IBusSimplePlugin_rspJoin_join_ready = (IBusSimplePlugin_iBusRsp_inputBeforeStage_ready && _zz_109_);
  assign IBusSimplePlugin_iBusRsp_inputBeforeStage_valid = (IBusSimplePlugin_rspJoin_join_valid && _zz_109_);
  ...
  assign dBus_cmd_valid = (((((execute_arbitration_isValid && execute_MEMORY_ENABLE) && (! execute_arbitration_isStuckByOthers)) && (! execute_arbitration_isFlushed)) && (! execute_DBusSimplePlugin_skipCmd)) && (! _zz_110_));
  assign dBus_cmd_payload_wr = execute_MEMORY_STORE;
  assign dBus_cmd_payload_size = execute_INSTRUCTION[13 : 12];
  always @ (*) begin
    case(dBus_cmd_payload_size)
      2'b00 : begin
        _zz_111_ = {{{execute_RS2[7 : 0],execute_RS2[7 : 0]},execute_RS2[7 : 0]},execute_RS2[7 : 0]};
      end
      2'b01 : begin
        _zz_111_ = {execute_RS2[15 : 0],execute_RS2[15 : 0]};
      end
      default : begin
        _zz_111_ = execute_RS2[31 : 0];
      end
    endcase
  end

  assign dBus_cmd_payload_data = _zz_111_;
  ...
  assign execute_DBusSimplePlugin_formalMask = (_zz_112_ <<< dBus_cmd_payload_address[1 : 0]);
  ...
  always @ (*) begin
    ...
    if(memory_ALIGNEMENT_FAULT)begin
      DBusSimplePlugin_memoryExceptionPort_payload_code = {1'd0, _zz_213_};
    end
    if(! memory_MMU_RSP_refilling) begin
      if(memory_MMU_FAULT)begin
  ...
  assign _zz_113_ = (writeBack_DBusSimplePlugin_rspShifted[7] && (! writeBack_INSTRUCTION[14]));
  always @ (*) begin
    ...
    _zz_114_[9] = _zz_113_;
    _zz_114_[8] = _zz_113_;
    _zz_114_[7 : 0] = writeBack_DBusSimplePlugin_rspShifted[7 : 0];
  end

  assign _zz_115_ = (writeBack_DBusSimplePlugin_rspShifted[15] && (! writeBack_INSTRUCTION[14]));
  always @ (*) begin
    ...
    _zz_116_[15 : 0] = writeBack_DBusSimplePlugin_rspShifted[15 : 0];
  end
  ...
  assign _zz_120_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001001000)) == (32'b00000000000000000000000001001000));
  assign _zz_121_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_117_ = {(((decode_INSTRUCTION & _zz_257_) == (32'b00000000000000000000000001010000)) != (1'b0)),{({_zz_258_,_zz_259_} != (2'b00)),{({_zz_260_,_zz_261_} != (2'b00)),{(_zz_262_ != _zz_263_),{_zz_264_,{_zz_265_,_zz_266_}}}}}};
  assign _zz_73_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_366_) == (32'b00000000000000000001000001110011)),{(_zz_367_ == _zz_368_),{_zz_369_,{_zz_370_,_zz_371_}}}}}}} != (19'b0000000000000000000));
  assign _zz_122_ = _zz_117_[1 : 0];
  assign _zz_72_ = _zz_122_;
  assign _zz_123_ = _zz_117_[3 : 2];
  assign _zz_71_ = _zz_123_;
  assign _zz_70_ = _zz_214_[0];
  assign _zz_124_ = _zz_117_[6 : 5];
  assign _zz_69_ = _zz_124_;
  assign _zz_68_ = _zz_215_[0];
  assign _zz_67_ = _zz_216_[0];
  assign _zz_66_ = _zz_217_[0];
  assign _zz_65_ = _zz_218_[0];
  assign _zz_125_ = _zz_117_[13 : 12];
  assign _zz_64_ = _zz_125_;
  assign _zz_63_ = _zz_219_[0];
  assign _zz_126_ = _zz_117_[16 : 15];
  assign _zz_62_ = _zz_126_;
  assign _zz_61_ = _zz_220_[0];
  assign _zz_60_ = _zz_221_[0];
  assign _zz_59_ = _zz_222_[0];
  assign _zz_127_ = _zz_117_[21 : 20];
  assign _zz_58_ = _zz_127_;
  assign _zz_57_ = _zz_223_[0];
  assign _zz_56_ = _zz_224_[0];
  assign _zz_55_ = _zz_225_[0];
  assign _zz_128_ = _zz_117_[25 : 25];
  assign _zz_54_ = _zz_128_;
  ...
  always @ (*) begin
    case(execute_SRC1_CTRL)
      ...
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : begin
        _zz_131_ = {29'd0, _zz_227_};
      end
      `Src1CtrlEnum_defaultEncoding_IMU : begin
        _zz_131_ = {execute_INSTRUCTION[31 : 12],(12'b000000000000)};
      end
      default : begin
        _zz_131_ = {27'd0, _zz_228_};
      end
    endcase
  end

  assign _zz_44_ = _zz_131_;
  assign _zz_132_ = _zz_229_[11];
  always @ (*) begin
  ...
  assign _zz_42_ = _zz_136_;
  always @ (*) begin
    execute_SrcPlugin_addSub = _zz_231_;
  ...
  always @ (*) begin
    _zz_138_ = 1'b0;
    if(_zz_141_)begin
      if((_zz_142_ == decode_INSTRUCTION[19 : 15]))begin
        _zz_138_ = 1'b1;
      end
    end
    if(_zz_187_)begin
  ...
  always @ (*) begin
    _zz_139_ = 1'b0;
    if(_zz_141_)begin
      if((_zz_142_ == decode_INSTRUCTION[24 : 20]))begin
        _zz_139_ = 1'b1;
      end
    end
    if(_zz_187_)begin
  ...
  assign _zz_140_ = (_zz_50_ && writeBack_arbitration_isFiring);
  ...
  assign _zz_34_ = _zz_145_;
  assign execute_BranchPlugin_branch_src1 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JALR) ? execute_RS1 : execute_PC);
  assign _zz_146_ = _zz_240_[19];
  always @ (*) begin
  ...
  always @ (*) begin
    case(execute_BRANCH_CTRL)
      `BranchCtrlEnum_defaultEncoding_JAL : begin
        _zz_152_ = {{_zz_147_,{{{execute_INSTRUCTION[31],execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]}},1'b0};
      end
      `BranchCtrlEnum_defaultEncoding_JALR : begin
        _zz_152_ = {_zz_149_,execute_INSTRUCTION[31 : 20]};
      end
      default : begin
        _zz_152_ = {{_zz_151_,{{{execute_INSTRUCTION[31],execute_INSTRUCTION[7]},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]}},1'b0};
      end
    endcase
  end

  assign execute_BranchPlugin_branch_src2 = _zz_152_;
  ...
  assign _zz_156_ = {decodeExceptionPort_valid,IBusSimplePlugin_decodeExceptionPort_valid};
  assign _zz_157_ = _zz_243_[0];
  assign _zz_158_ = {BranchPlugin_branchExceptionPort_valid,DBusSimplePlugin_memoryExceptionPort_valid};
  assign _zz_159_ = _zz_245_[0];
  always @ (*) begin
  ...
  assign externalInterrupt = (_zz_161_ != (32'b00000000000000000000000000000000));
  always @ (*) begin
  ...
  always @ (posedge clk) begin
    if(reset) begin
      ...
      _zz_160_ <= (32'b00000000000000000000000000000000);
      ...
      if(_zz_101_)begin
        _zz_103_ <= IBusSimplePlugin_iBusRsp_stages_0_output_valid;
      end
      if(IBusSimplePlugin_iBusRsp_inputBeforeStage_ready)begin
        _zz_104_ <= IBusSimplePlugin_iBusRsp_inputBeforeStage_valid;
      end
      if((IBusSimplePlugin_jump_pcLoad_valid || IBusSimplePlugin_fetcherflushIt))begin
        _zz_104_ <= 1'b0;
      end
      ...
      IBusSimplePlugin_rspJoin_discardCounter <= (IBusSimplePlugin_rspJoin_discardCounter - _zz_210_);
      if((IBusSimplePlugin_jump_pcLoad_valid || IBusSimplePlugin_fetcherflushIt))begin
        IBusSimplePlugin_rspJoin_discardCounter <= (IBusSimplePlugin_pendingCmd - _zz_212_);
      end
      _zz_129_ <= 1'b0;
      if(_zz_171_)begin
        if(_zz_174_)begin
      ...
      execute_CsrPlugin_wfiWake <= ({_zz_155_,{_zz_154_,_zz_153_}} != (3'b000));
      if((! writeBack_arbitration_isStuck))begin
      ...
      case(execute_CsrPlugin_csrAddress)
        ...
        12'b001100000100 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_mie_MEIE <= _zz_250_[0];
            CsrPlugin_mie_MTIE <= _zz_251_[0];
            CsrPlugin_mie_MSIE <= _zz_252_[0];
          end
        end
        12'b001101000010 : begin
        end
  ...
  always @ (posedge clk) begin
    if(IBusSimplePlugin_iBusRsp_inputBeforeStage_ready)begin
      _zz_105_ <= IBusSimplePlugin_iBusRsp_inputBeforeStage_payload_pc;
      _zz_106_ <= IBusSimplePlugin_iBusRsp_inputBeforeStage_payload_rsp_error;
      _zz_107_ <= IBusSimplePlugin_iBusRsp_inputBeforeStage_payload_rsp_inst;
      _zz_108_ <= IBusSimplePlugin_iBusRsp_inputBeforeStage_payload_isRvc;
    end
    if(IBusSimplePlugin_injector_decodeInput_ready)begin
    ...
    if(_zz_173_)begin
      CsrPlugin_exceptionPortCtrl_exceptionContext_code <= (_zz_157_ ? IBusSimplePlugin_decodeExceptionPort_payload_code : decodeExceptionPort_payload_code);
      CsrPlugin_exceptionPortCtrl_exceptionContext_badAddr <= (_zz_157_ ? IBusSimplePlugin_decodeExceptionPort_payload_badAddr : decodeExceptionPort_payload_badAddr);
    end
    if(_zz_176_)begin
      CsrPlugin_exceptionPortCtrl_exceptionContext_code <= (_zz_159_ ? DBusSimplePlugin_memoryExceptionPort_payload_code : BranchPlugin_branchExceptionPort_payload_code);
      CsrPlugin_exceptionPortCtrl_exceptionContext_badAddr <= (_zz_159_ ? DBusSimplePlugin_memoryExceptionPort_payload_badAddr : BranchPlugin_branchExceptionPort_payload_badAddr);
    end
    if(_zz_178_)begin
      case(CsrPlugin_targetPrivilege)
        2'b11 : begin
    ...
    if((_zz_163_ != (3'b000)))begin
      _zz_107_ <= IBusSimplePlugin_injectionPort_payload;
    end
    case(execute_CsrPlugin_csrAddress)
      12'b101111000000 : begin
      end
  ...
  always @ (posedge clk) begin
    ...
    _zz_162_ <= debug_bus_cmd_payload_address[2];
    if(_zz_175_)begin
