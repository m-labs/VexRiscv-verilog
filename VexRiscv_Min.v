...
module VexRiscv (
  ...
  assign _zz_169_ = ({decodeExceptionPort_valid,IBusSimplePlugin_decodeExceptionPort_valid} != (2'b00));
  assign _zz_170_ = (! execute_arbitration_isStuckByOthers);
  ...
  assign _zz_175_ = (IBusSimplePlugin_fetchPc_preOutput_valid && IBusSimplePlugin_fetchPc_preOutput_ready);
  assign _zz_176_ = (IBusSimplePlugin_mmuBus_rsp_exception || IBusSimplePlugin_mmuBus_rsp_refilling);
  assign _zz_177_ = ((IBusSimplePlugin_iBusRsp_stages_1_input_valid && (! IBusSimplePlugin_mmu_joinCtx_refilling)) && (IBusSimplePlugin_mmu_joinCtx_exception || (! IBusSimplePlugin_mmu_joinCtx_allowExecute)));
  assign _zz_178_ = ((dBus_rsp_ready && dBus_rsp_error) && (! memory_MEMORY_STORE));
  ...
  assign _zz_181_ = (1'b1 || (! 1'b1));
  assign _zz_182_ = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_183_ = (1'b1 || (! memory_BYPASSABLE_MEMORY_STAGE));
  assign _zz_184_ = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_185_ = (1'b1 || (! execute_BYPASSABLE_EXECUTE_STAGE));
  assign _zz_186_ = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < (2'b11)));
  assign _zz_187_ = ((_zz_151_ && 1'b1) && (! 1'b0));
  assign _zz_188_ = ((_zz_152_ && 1'b1) && (! 1'b0));
  assign _zz_189_ = ((_zz_153_ && 1'b1) && (! 1'b0));
  assign _zz_190_ = (! dBus_cmd_halfPipe_regs_valid);
  assign _zz_191_ = writeBack_INSTRUCTION[13 : 12];
  assign _zz_192_ = execute_INSTRUCTION[13];
  assign _zz_193_ = (_zz_90_ - (4'b0001));
  assign _zz_194_ = {IBusSimplePlugin_fetchPc_inc,(2'b00)};
  assign _zz_195_ = {29'd0, _zz_194_};
  assign _zz_196_ = (IBusSimplePlugin_pendingCmd + _zz_198_);
  assign _zz_197_ = (IBusSimplePlugin_cmd_valid && IBusSimplePlugin_cmd_ready);
  assign _zz_198_ = {2'd0, _zz_197_};
  assign _zz_199_ = iBus_rsp_valid;
  assign _zz_200_ = {2'd0, _zz_199_};
  assign _zz_201_ = (iBus_rsp_valid && (IBusSimplePlugin_rspJoin_discardCounter != (3'b000)));
  assign _zz_202_ = {2'd0, _zz_201_};
  assign _zz_203_ = iBus_rsp_valid;
  assign _zz_204_ = {2'd0, _zz_203_};
  assign _zz_205_ = (memory_MEMORY_STORE ? (3'b110) : (3'b100));
  assign _zz_206_ = _zz_115_[2 : 2];
  assign _zz_207_ = _zz_115_[3 : 3];
  assign _zz_208_ = _zz_115_[4 : 4];
  assign _zz_209_ = _zz_115_[5 : 5];
  assign _zz_210_ = _zz_115_[8 : 8];
  assign _zz_211_ = _zz_115_[10 : 10];
  assign _zz_212_ = _zz_115_[14 : 14];
  assign _zz_213_ = _zz_115_[15 : 15];
  assign _zz_214_ = _zz_115_[18 : 18];
  assign _zz_215_ = _zz_115_[19 : 19];
  assign _zz_216_ = _zz_115_[24 : 24];
  assign _zz_217_ = execute_SRC_LESS;
  assign _zz_218_ = (3'b100);
  assign _zz_219_ = execute_INSTRUCTION[19 : 15];
  assign _zz_220_ = execute_INSTRUCTION[31 : 20];
  assign _zz_221_ = {execute_INSTRUCTION[31 : 25],execute_INSTRUCTION[11 : 7]};
  assign _zz_222_ = ($signed(_zz_223_) + $signed(_zz_226_));
  assign _zz_223_ = ($signed(_zz_224_) + $signed(_zz_225_));
  assign _zz_224_ = execute_SRC1;
  assign _zz_225_ = (execute_SRC_USE_SUB_LESS ? (~ execute_SRC2) : execute_SRC2);
  assign _zz_226_ = (execute_SRC_USE_SUB_LESS ? _zz_227_ : _zz_228_);
  assign _zz_227_ = (32'b00000000000000000000000000000001);
  assign _zz_228_ = (32'b00000000000000000000000000000000);
  assign _zz_229_ = (_zz_230_ >>> 1);
  assign _zz_230_ = {((execute_SHIFT_CTRL == `ShiftCtrlEnum_defaultEncoding_SRA_1) && execute_LightShifterPlugin_shiftInput[31]),execute_LightShifterPlugin_shiftInput};
  assign _zz_231_ = {{{execute_INSTRUCTION[31],execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]};
  ...
  assign _zz_234_ = (_zz_154_ & (~ _zz_235_));
  assign _zz_235_ = (_zz_154_ - (2'b01));
  assign _zz_236_ = (_zz_156_ & (~ _zz_237_));
  assign _zz_237_ = (_zz_156_ - (2'b01));
  ...
  assign _zz_244_ = ({3'd0,_zz_162_} <<< dBus_cmd_halfPipe_payload_address[1 : 0]);
  assign _zz_245_ = 1'b1;
  assign _zz_246_ = 1'b1;
  assign _zz_247_ = {_zz_94_,_zz_93_};
  assign _zz_248_ = (32'b00000000000000000000000001011000);
  assign _zz_249_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_250_ = _zz_119_;
  assign _zz_251_ = ((decode_INSTRUCTION & _zz_257_) == (32'b00000000000000000000000000000000));
  assign _zz_252_ = ((decode_INSTRUCTION & _zz_258_) == (32'b00000000000000000101000000010000));
  assign _zz_253_ = (1'b0);
  assign _zz_254_ = ({_zz_259_,_zz_260_} != (2'b00));
  assign _zz_255_ = ({_zz_261_,_zz_262_} != (2'b00));
  assign _zz_256_ = {(_zz_263_ != _zz_264_),{_zz_265_,{_zz_266_,_zz_267_}}};
  assign _zz_257_ = (32'b00000000000000000000000000100000);
  assign _zz_258_ = (32'b00000000000000000111000001010100);
  assign _zz_259_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_260_ = ((decode_INSTRUCTION & (32'b00000000000000000111000001010100)) == (32'b00000000000000000001000000010000));
  ...
  assign _zz_263_ = ((decode_INSTRUCTION & _zz_270_) == (32'b00000000000000000000000000100000));
  assign _zz_264_ = (1'b0);
  assign _zz_265_ = ((_zz_271_ == _zz_272_) != (1'b0));
  assign _zz_266_ = (_zz_273_ != (1'b0));
  ...
  assign _zz_273_ = ((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000010000000000000));
  assign _zz_274_ = {((decode_INSTRUCTION & _zz_279_) == (32'b00000000000000000000000001000000)),{(_zz_280_ == _zz_281_),(_zz_282_ == _zz_283_)}};
  assign _zz_275_ = (3'b000);
  assign _zz_276_ = (_zz_117_ != (1'b0));
  assign _zz_277_ = ((_zz_284_ == _zz_285_) != (1'b0));
  assign _zz_278_ = {({_zz_286_,_zz_287_} != (2'b00)),{(_zz_288_ != _zz_289_),{_zz_290_,{_zz_291_,_zz_292_}}}};
  assign _zz_279_ = (32'b00000000000000000000000001000100);
  assign _zz_280_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  assign _zz_281_ = (32'b00000000000000000010000000010000);
  assign _zz_282_ = (decode_INSTRUCTION & (32'b01000000000000000100000000110100));
  assign _zz_283_ = (32'b01000000000000000000000000110000);
  assign _zz_284_ = (decode_INSTRUCTION & (32'b00000000000000000011000001010000));
  assign _zz_285_ = (32'b00000000000000000000000001010000);
  assign _zz_286_ = ((decode_INSTRUCTION & _zz_293_) == (32'b00000000000000000110000000010000));
  assign _zz_287_ = ((decode_INSTRUCTION & _zz_294_) == (32'b00000000000000000100000000010000));
  assign _zz_288_ = ((decode_INSTRUCTION & _zz_295_) == (32'b00000000000000000010000000010000));
  assign _zz_289_ = (1'b0);
  assign _zz_290_ = ((_zz_296_ == _zz_297_) != (1'b0));
  assign _zz_291_ = ({_zz_298_,_zz_299_} != (3'b000));
  assign _zz_292_ = {(_zz_300_ != _zz_301_),{_zz_302_,{_zz_303_,_zz_304_}}};
  assign _zz_293_ = (32'b00000000000000000110000000010100);
  assign _zz_294_ = (32'b00000000000000000101000000010100);
  assign _zz_295_ = (32'b00000000000000000110000000010100);
  assign _zz_296_ = (decode_INSTRUCTION & (32'b00000000000000000000000000010000));
  assign _zz_297_ = (32'b00000000000000000000000000010000);
  assign _zz_298_ = ((decode_INSTRUCTION & _zz_305_) == (32'b00000000000000000000000001000000));
  assign _zz_299_ = {(_zz_306_ == _zz_307_),(_zz_308_ == _zz_309_)};
  assign _zz_300_ = {(_zz_310_ == _zz_311_),(_zz_312_ == _zz_313_)};
  assign _zz_301_ = (2'b00);
  assign _zz_302_ = ({_zz_314_,_zz_118_} != (2'b00));
  assign _zz_303_ = ({_zz_315_,_zz_316_} != (2'b00));
  assign _zz_304_ = {(_zz_317_ != _zz_318_),{_zz_319_,{_zz_320_,_zz_321_}}};
  assign _zz_305_ = (32'b00000000000000000000000001010000);
  assign _zz_306_ = (decode_INSTRUCTION & (32'b00000000000000000011000001000000));
  assign _zz_307_ = (32'b00000000000000000000000001000000);
  assign _zz_308_ = (decode_INSTRUCTION & (32'b00000000000000000000000000111000));
  assign _zz_309_ = (32'b00000000000000000000000000000000);
  assign _zz_310_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_311_ = (32'b00000000000000000000000000100100);
  assign _zz_312_ = (decode_INSTRUCTION & (32'b00000000000000000011000001010100));
  assign _zz_313_ = (32'b00000000000000000001000000010000);
  assign _zz_314_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_315_ = ((decode_INSTRUCTION & _zz_322_) == (32'b00000000000000000000000000000100));
  assign _zz_316_ = _zz_118_;
  assign _zz_317_ = {(_zz_323_ == _zz_324_),{_zz_325_,{_zz_326_,_zz_327_}}};
  assign _zz_318_ = (4'b0000);
  assign _zz_319_ = ({_zz_328_,_zz_329_} != (2'b00));
  assign _zz_320_ = ({_zz_330_,_zz_331_} != (2'b00));
  assign _zz_321_ = {(_zz_332_ != _zz_333_),{_zz_334_,_zz_335_}};
  assign _zz_322_ = (32'b00000000000000000000000001000100);
  assign _zz_323_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_324_ = (32'b00000000000000000000000000000000);
  assign _zz_325_ = ((decode_INSTRUCTION & _zz_336_) == (32'b00000000000000000000000000000000));
  assign _zz_326_ = (_zz_337_ == _zz_338_);
  assign _zz_327_ = (_zz_339_ == _zz_340_);
  assign _zz_328_ = ((decode_INSTRUCTION & _zz_341_) == (32'b00000000000000000010000000000000));
  assign _zz_329_ = ((decode_INSTRUCTION & _zz_342_) == (32'b00000000000000000001000000000000));
  assign _zz_330_ = (_zz_343_ == _zz_344_);
  assign _zz_331_ = (_zz_345_ == _zz_346_);
  assign _zz_332_ = {_zz_116_,{_zz_347_,_zz_348_}};
  assign _zz_333_ = (6'b000000);
  assign _zz_334_ = ({_zz_349_,_zz_350_} != (2'b00));
  assign _zz_335_ = (_zz_351_ != (1'b0));
  assign _zz_336_ = (32'b00000000000000000000000000011000);
  assign _zz_337_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_338_ = (32'b00000000000000000010000000000000);
  assign _zz_339_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000100));
  assign _zz_340_ = (32'b00000000000000000001000000000000);
  assign _zz_341_ = (32'b00000000000000000010000000010000);
  assign _zz_342_ = (32'b00000000000000000101000000000000);
  assign _zz_343_ = (decode_INSTRUCTION & (32'b00000000000000000001000001010000));
  assign _zz_344_ = (32'b00000000000000000001000001010000);
  assign _zz_345_ = (decode_INSTRUCTION & (32'b00000000000000000010000001010000));
  assign _zz_346_ = (32'b00000000000000000010000001010000);
  assign _zz_347_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000010000)) == (32'b00000000000000000001000000010000));
  assign _zz_348_ = {((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000010000)),{_zz_117_,{(_zz_352_ == _zz_353_),(_zz_354_ == _zz_355_)}}};
  assign _zz_349_ = _zz_116_;
  assign _zz_350_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011100)) == (32'b00000000000000000000000000000100));
  assign _zz_351_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_352_ = (decode_INSTRUCTION & (32'b00000000000000000000000000001100));
  assign _zz_353_ = (32'b00000000000000000000000000000100);
  assign _zz_354_ = (decode_INSTRUCTION & (32'b00000000000000000000000000101000));
  assign _zz_355_ = (32'b00000000000000000000000000000000);
  assign _zz_356_ = (32'b00000000000000000001000001111111);
  assign _zz_357_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_358_ = (32'b00000000000000000010000001110011);
  assign _zz_359_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_360_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_361_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_362_) == (32'b00000000000000000000000000000011)),{(_zz_363_ == _zz_364_),{_zz_365_,{_zz_366_,_zz_367_}}}}}};
  assign _zz_362_ = (32'b00000000000000000101000001011111);
  assign _zz_363_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_364_ = (32'b00000000000000000000000001100011);
  assign _zz_365_ = ((decode_INSTRUCTION & (32'b00000000000000000110000001111111)) == (32'b00000000000000000000000000001111));
  assign _zz_366_ = ((decode_INSTRUCTION & (32'b11111110000000000000000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_367_ = {((decode_INSTRUCTION & (32'b10111100000000000111000001111111)) == (32'b00000000000000000101000000010011)),{((decode_INSTRUCTION & (32'b11111100000000000011000001111111)) == (32'b00000000000000000001000000010011)),{((decode_INSTRUCTION & _zz_368_) == (32'b00000000000000000101000000110011)),{(_zz_369_ == _zz_370_),(_zz_371_ == _zz_372_)}}}};
  assign _zz_368_ = (32'b10111110000000000111000001111111);
  assign _zz_369_ = (decode_INSTRUCTION & (32'b10111110000000000111000001111111));
  assign _zz_370_ = (32'b00000000000000000000000000110011);
  assign _zz_371_ = (decode_INSTRUCTION & (32'b11011111111111111111111111111111));
  assign _zz_372_ = (32'b00010000001000000000000001110011);
  always @ (posedge clk) begin
    if(_zz_50_) begin
  ...
  always @ (posedge clk) begin
    if(_zz_245_) begin
      _zz_164_ <= RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress1];
    end
  end

  always @ (posedge clk) begin
    if(_zz_246_) begin
      _zz_165_ <= RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress2];
    end
  end
  ...
  always @(*) begin
    case(_zz_247_)
      2'b00 : begin
        _zz_166_ = CsrPlugin_jumpInterface_payload;
      end
      2'b01 : begin
        _zz_166_ = DBusSimplePlugin_redoBranch_payload;
      end
      2'b10 : begin
        _zz_166_ = BranchPlugin_jumpInterface_payload;
      end
      default : begin
        _zz_166_ = IBusSimplePlugin_redoBranch_payload;
      end
    endcase
  end
  ...
  always @(*) begin
    case(_zz_62_)
      `AluCtrlEnum_defaultEncoding_ADD_SUB : _zz_62__string = "ADD_SUB ";
      `AluCtrlEnum_defaultEncoding_SLT_SLTU : _zz_62__string = "SLT_SLTU";
      `AluCtrlEnum_defaultEncoding_BITWISE : _zz_62__string = "BITWISE ";
  ...
  assign _zz_91_ = (_zz_90_ & (~ _zz_193_));
  assign _zz_92_ = _zz_91_[3];
  assign _zz_93_ = (_zz_91_[1] || _zz_92_);
  assign _zz_94_ = (_zz_91_[2] || _zz_92_);
  assign IBusSimplePlugin_jump_pcLoad_payload = _zz_166_;
  assign _zz_95_ = (! IBusSimplePlugin_fetcherHalt);
  assign IBusSimplePlugin_fetchPc_output_valid = (IBusSimplePlugin_fetchPc_preOutput_valid && _zz_95_);
  assign IBusSimplePlugin_fetchPc_preOutput_ready = (IBusSimplePlugin_fetchPc_output_ready && _zz_95_);
  ...
  assign IBusSimplePlugin_fetchPc_preOutput_valid = _zz_96_;
  ...
  assign IBusSimplePlugin_pendingCmdNext = (_zz_196_ - _zz_200_);
  always @ (*) begin
  ...
  assign _zz_163_ = (IBusSimplePlugin_jump_pcLoad_valid || IBusSimplePlugin_fetcherflushIt);
  ...
  always @ (*) begin
    ...
    if(memory_ALIGNEMENT_FAULT)begin
      DBusSimplePlugin_memoryExceptionPort_payload_code = {1'd0, _zz_205_};
    end
    if(! memory_MMU_RSP_refilling) begin
      if(memory_MMU_FAULT)begin
  ...
  assign _zz_119_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_115_ = {(((decode_INSTRUCTION & _zz_248_) == (32'b00000000000000000000000000000000)) != (1'b0)),{({_zz_119_,_zz_249_} != (2'b00)),{({_zz_250_,_zz_251_} != (2'b00)),{(_zz_252_ != _zz_253_),{_zz_254_,{_zz_255_,_zz_256_}}}}}};
  assign _zz_71_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_356_) == (32'b00000000000000000001000001110011)),{(_zz_357_ == _zz_358_),{_zz_359_,{_zz_360_,_zz_361_}}}}}}} != (18'b000000000000000000));
  assign _zz_120_ = _zz_115_[1 : 0];
  assign _zz_70_ = _zz_120_;
  assign _zz_69_ = _zz_206_[0];
  assign _zz_68_ = _zz_207_[0];
  assign _zz_67_ = _zz_208_[0];
  assign _zz_66_ = _zz_209_[0];
  assign _zz_121_ = _zz_115_[7 : 6];
  assign _zz_65_ = _zz_121_;
  assign _zz_64_ = _zz_210_[0];
  assign _zz_63_ = _zz_211_[0];
  assign _zz_122_ = _zz_115_[12 : 11];
  assign _zz_62_ = _zz_122_;
  assign _zz_123_ = _zz_115_[13 : 13];
  assign _zz_61_ = _zz_123_;
  assign _zz_60_ = _zz_212_[0];
  assign _zz_59_ = _zz_213_[0];
  assign _zz_124_ = _zz_115_[17 : 16];
  assign _zz_58_ = _zz_124_;
  assign _zz_57_ = _zz_214_[0];
  assign _zz_56_ = _zz_215_[0];
  assign _zz_125_ = _zz_115_[21 : 20];
  assign _zz_55_ = _zz_125_;
  assign _zz_126_ = _zz_115_[23 : 22];
  assign _zz_54_ = _zz_126_;
  assign _zz_53_ = _zz_216_[0];
  assign decodeExceptionPort_valid = ((decode_arbitration_isValid && decode_INSTRUCTION_READY) && (! decode_LEGAL_INSTRUCTION));
  assign decodeExceptionPort_payload_code = (4'b0010);
  assign decodeExceptionPort_payload_badAddr = decode_INSTRUCTION;
  assign decode_RegFilePlugin_regFileReadAddress1 = decode_INSTRUCTION_ANTICIPATED[19 : 15];
  assign decode_RegFilePlugin_regFileReadAddress2 = decode_INSTRUCTION_ANTICIPATED[24 : 20];
  assign decode_RegFilePlugin_rs1Data = _zz_164_;
  assign decode_RegFilePlugin_rs2Data = _zz_165_;
  ...
  always @ (*) begin
    case(execute_SRC1_CTRL)
      ...
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : begin
        _zz_129_ = {29'd0, _zz_218_};
      end
      `Src1CtrlEnum_defaultEncoding_IMU : begin
        _zz_129_ = {execute_INSTRUCTION[31 : 12],(12'b000000000000)};
      end
      default : begin
        _zz_129_ = {27'd0, _zz_219_};
      end
    endcase
  end

  assign _zz_43_ = _zz_129_;
  assign _zz_130_ = _zz_220_[11];
  always @ (*) begin
  ...
  assign _zz_41_ = _zz_134_;
  always @ (*) begin
    execute_SrcPlugin_addSub = _zz_222_;
  ...
  assign _zz_33_ = _zz_143_;
  assign execute_BranchPlugin_branch_src1 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JALR) ? execute_RS1 : execute_PC);
  assign _zz_144_ = _zz_231_[19];
  always @ (*) begin
  ...
  assign iBus_cmd_m2sPipe_valid = _zz_160_;
  assign iBus_cmd_m2sPipe_payload_pc = _zz_161_;
  ...
  always @ (posedge clk) begin
    if(reset) begin
      ...
      IBusSimplePlugin_rspJoin_discardCounter <= (IBusSimplePlugin_rspJoin_discardCounter - _zz_202_);
      if((IBusSimplePlugin_jump_pcLoad_valid || IBusSimplePlugin_fetcherflushIt))begin
        IBusSimplePlugin_rspJoin_discardCounter <= (IBusSimplePlugin_pendingCmd - _zz_204_);
      end
      _zz_127_ <= 1'b0;
      if(_zz_167_)begin
        if(_zz_170_)begin
