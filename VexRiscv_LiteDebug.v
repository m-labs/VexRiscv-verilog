...
module VexRiscv (
  ...
  assign _zz_255_ = (! memory_arbitration_isStuck);
  assign _zz_256_ = debug_bus_cmd_payload_address[7 : 2];
  assign _zz_257_ = (iBus_cmd_valid || (_zz_207_ != (3'b000)));
  ...
  assign _zz_261_ = ((_zz_191_ && 1'b1) && (! 1'b0));
